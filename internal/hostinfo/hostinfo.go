...
type (
	...
	//
	//  - Some tools use "x86_64" for CPU architecture, while some use "amd64", and others even use
	//    "x64"
	//  - In addition to a kernel ID, some tools additionally specify an OS value (e.g. both
	//    "darwin" and "macos")
	Input struct {
